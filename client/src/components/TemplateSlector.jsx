...
//     const templates = [
//         { id: 'classic', name: 'Classic', preview: "A clean, traditional resume format with a clear sections and professional typography."  },
//         { id: 'modern', name: 'Modern', preview: "A sleek, modern resume design with bold headers and a minimalist layout."  },
//         { id: 'minimal', name: 'Minimal', preview: "A simple and clean resume template focusing on essential information."  },
//         { id: 'minimalImage', name: 'Minimal with Image', preview: "A minimal resume template that includes a profile image." },
//     ];
//   return (
