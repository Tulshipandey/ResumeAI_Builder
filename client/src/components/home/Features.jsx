...
const Features = () => {
  ...
  return (
    <div id = 'features' className='flex flex-col items-center my-10 scroll-mt-12'> 
        ...
        <Title title="Build your resume effortlessly" description="Our AI-powered tool streamlines the resume creation process, making it faster and easier than ever before." />
